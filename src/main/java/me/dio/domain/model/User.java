...
public class User {
    ...
    @OneToMany(cascade = CascadeType.ALL, fetch = FetchType.EAGER) // o eager siginifica que toda vez que buscar um usuario no banco, irá trazer a lista de features dele
